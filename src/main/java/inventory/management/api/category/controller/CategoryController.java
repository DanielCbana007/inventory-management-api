...
/*
 * ==== LEYENDA DE LAS ANOTACIONES (revision 1) ====
 * SEGURIDAD : agujero explotable. Falla inmediata en la escala.
 * BUG       : el código hace algo incorrecto al ejecutarse.
 * ERROR     : viola un estándar del proyecto (capas, REST, errores).
 * FALTA     : algo que debería existir y no está.
 * MEJORA    : no bloquea, pero separa Competente de Experto.
 * El sufijo [§x.y] apunta a la sección de las notas de la revision 1
 */
...
public class CategoryController {
    ...
    //               PATCH (parcial). Esa distinción es clave en REST.
