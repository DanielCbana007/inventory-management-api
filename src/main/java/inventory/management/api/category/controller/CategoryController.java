...
public class CategoryController {
    ...
    public ResponseEntity<CategoryDto> update(
        ...
        // OK [§4]: el bloqueante de la revision 3 esta cerrado. El service ya aplica los
