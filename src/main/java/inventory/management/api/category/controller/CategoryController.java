...
/*
 * ==== PENDIENTE - las notas de la revision 2 ====
 *
 * TODO   : hay que hacerlo. [§x] apunta a la sección de la revisión.
 * MEJORA : opcional. No bloquea, pero es lo que separa Competente de Experto.
 *
 ...
 *            Es el único eje que sigue sin poder evaluarse, y en la escala
...
public class CategoryController {
    ...
    //              no tu contrato. Es requisito de nivel junior y está en Insuficiente.
